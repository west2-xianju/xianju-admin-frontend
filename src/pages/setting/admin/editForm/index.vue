    ...
    <div class="form-basic-container">
      <div class="form-basic-item">
        ...
        <t-row class="row-gap" :gutter="[32, 24]">
          <t-col :span="7">
            <t-form-item label="管理员ID" name="admin_id">
              <t-input v-model="formData.admin_id" disabled></t-input>
            </t-form-item>
          </t-col>
          <t-col :span="4">
...
import { updateAdmin } from '@/api/admin/admin';
...
const onSubmit = async ({ validateResult }) => {
  if (validateResult === true) {
    try {
      await updateAdmin(formData.value.admin_id, formData.value);
    } catch (error) {
      console.log(error);
    } finally {
